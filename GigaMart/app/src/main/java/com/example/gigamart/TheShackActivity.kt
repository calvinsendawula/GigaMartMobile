...
class TheShackActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_the_shack)

        val addToCartClick = findViewById<Button>(R.id.btnAddToCart)
        addToCartClick.setOnClickListener {
