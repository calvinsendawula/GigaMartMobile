...
class LocationsActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val locationClick1 = findViewById<CardView>(R.id.btnKilimani)
        locationClick1.setOnClickListener {
            val intent = Intent(this, RestaurantsActivity::class.java)
            startActivity(intent)
        }

        val locationClick2 = findViewById<CardView>(R.id.btnNairobiWest)
        locationClick2.setOnClickListener {
            val intent = Intent(this, RestaurantsActivity::class.java)
            startActivity(intent)
        }

        val locationClick3 = findViewById<CardView>(R.id.btnSouthB)
        locationClick3.setOnClickListener {
            val intent = Intent(this, RestaurantsActivity::class.java)
            startActivity(intent)
        }
    }
